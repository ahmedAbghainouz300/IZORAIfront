...
const assuranceService = {
  ...
  getTotalPrimesAnnuelles: () =>
    axiosClient.get("/api/assurances/total-primes-annuelles"),
  ...
  getAssurancesExpirantDans30Jours: () =>
    axiosClient.get("/api/assurances/expirant-dans-30-jours"),
};
